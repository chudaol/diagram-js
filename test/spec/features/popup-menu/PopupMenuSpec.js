...
describe('features/popup', function() {
  ...
  describe('#open', function() {
    ...
    it('should attach popup to html', inject(function(popupMenu) {
      ...
      // then
      expect(document.querySelector('.abcde')).toBeDefined(); // TODO smarter check
    }));
    ...
    it('should add entries to menu', inject(function(popupMenu) {
      ...
      // then
      var element = document.querySelector('.firstEntry');
    ...
    it('should exectute handler on click');


        // describe('position', function() {
    //
    //   it('should open at x,y', inject(function() {
    //
    //     // given
    //     var popup = popupMenu.open({
    //       x: 100,
